...
function Contact() {
  ...
  return (
    <div className="min-h-2 bg-gradient-to-r from-pink-100 to-pink-200 p-6">
     ...
     {/* Contact Section */}
      <section className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg mt-8 p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start justify-between md:gap-16">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-xl font-semibold text-pink-600 mb-4">Our Contact Information</h3>
      ...
      {/* Footer */}
      <footer className="text-center bg-pink-500 text-white py-4 mt-10 rounded-lg shadow-md">
        <p>&copy; Online Beauty Store. All Rights Reserved.</p>
      </footer>
    </div>
  );
}
